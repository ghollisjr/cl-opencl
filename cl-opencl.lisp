    ...
    (with-foreign-object (p :char (mem-ref size 'size-t))
      ...
      (cond
        ...
        ((= param +CL-DEVICE-AVAILABLE+)
         (mem-ref p 'cl-bool))
        ((= param +CL-DEVICE-BUILT-IN-KERNELS+)
        ...
        ((= param +CL-DEVICE-GLOBAL-MEM-SIZE+)
         (mem-ref p 'cl-ulong))
        ((= param +CL-DEVICE-GLOBAL-VARIABLE-PREFERRED-TOTAL-SIZE+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-IL-VERSION+)
         (foreign-string-to-lisp p))
        ...
        ((= param +CL-DEVICE-IMAGE3D-MAX-WIDTH+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-IMAGE-BASE-ADDRESS-ALIGNMENT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-IMAGE-MAX-ARRAY-SIZE+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-IMAGE-MAX-BUFFER-SIZE+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-IMAGE-PITCH-ALIGNMENT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-LINKER-AVAILABLE+)
         (mem-ref p 'cl-bool))
        ...
        ((= param +CL-DEVICE-MAX-CONSTANT-BUFFER-SIZE+)
         (mem-ref p 'cl-ulong))
        ((= param +CL-DEVICE-MAX-GLOBAL-VARIABLE-SIZE+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-MAX-MEM-ALLOC-SIZE+)
         (mem-ref p 'cl-ulong))
        ((= param +CL-DEVICE-MAX-NUM-SUB-GROUPS+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-MAX-ON-DEVICE-QUEUES+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-MAX-PARAMETER-SIZE+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-MAX-PIPE-ARGS+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-MAX-READ-IMAGE-ARGS+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-MAX-READ-WRITE-IMAGE-ARGS+)
         (mem-ref p 'cl-uint))
        ...
        ((= param +CL-DEVICE-MAX-WORK-ITEM-SIZES+)
         (let* ((nitems (floor (mem-ref size 'size-t)
        ...
        ((= param +CL-DEVICE-MIN-DATA-TYPE-ALIGN-SIZE+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-CHAR+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-SHORT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-INT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-LONG+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-FLOAT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-DOUBLE+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-NATIVE-VECTOR-WIDTH-HALF+)
         (mem-ref p 'cl-uint))

        ((= param +CL-DEVICE-PREFERRED-GLOBAL-ATOMIC-ALIGNMENT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-LOCAL-ATOMIC-ALIGNMENT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-PLATFORM-ATOMIC-ALIGNMENT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-CHAR+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-SHORT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-INT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-LONG+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-FLOAT+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-DOUBLE+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-VECTOR-WIDTH-HALF+)
         (mem-ref p 'cl-uint))

        ((= param +CL-DEVICE-OPENCL-C-VERSION+)
         (foreign-string-to-lisp p))
        ((= param +CL-DEVICE-PARENT-DEVICE+)
         (mem-ref p 'cl-device-id))
        ((= param +CL-DEVICE-PARTITION-AFFINITY-DOMAIN+)
         (mem-ref p 'cl-device-affinity-domain))
        ((= param +CL-DEVICE-PARTITION-MAX-SUB-DEVICES+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PARTITION-PROPERTIES+)
         (let* ((nitems (floor (mem-ref size 'size-t)
                               (foreign-type-size 'cl-device-partition-property))))
           (loop
              for i below nitems
              collecting (mem-aref p 'cl-device-partition-property i))))
        ((= param +CL-DEVICE-PARTITION-TYPE+)
         (let* ((nitems (floor (mem-ref size 'size-t)
                               (foreign-type-size 'cl-device-partition-property))))
           (loop
              for i below nitems
              collecting (mem-aref p 'cl-device-partition-property i))))
        ((= param +CL-DEVICE-PIPE-MAX-ACTIVE-RESERVATIONS+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PIPE-MAX-PACKET-SIZE+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-PREFERRED-INTEROP-USER-SYNC+)
         (mem-ref p 'cl-bool))
        ((= param +CL-DEVICE-PRINTF-BUFFER-SIZE+)
         (mem-ref p 'size-t))
        ((= param +CL-DEVICE-QUEUE-ON-DEVICE-MAX-SIZE+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-QUEUE-ON-DEVICE-PREFERRED-SIZE+)
         (mem-ref p 'cl-uint))
        ((= param +CL-DEVICE-QUEUE-ON-DEVICE-PROPERTIES+)
         (mem-ref p 'cl-command-queue-properties))
        ((= param +CL-DEVICE-REFERENCE-COUNT+)
         (mem-ref p 'cl-uint))
